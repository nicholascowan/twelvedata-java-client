 ...
 * 
 * <p>This abstract class provides common functionality for all TwelveData API endpoints,
 * including parameter management, HTTP request execution, and response handling.</p>
 * 
 * <p>Key features:</p>
 * <ul>
 *   <li>Parameter management with type-safe addParam methods</li>
 *   <li>JSON and CSV response handling</li>
 *   <li>URL generation for debugging</li>
 *   <li>Endpoint type classification (price, indicator, overlay, batch)</li>
 * </ul>
 * 
 * <p>Subclasses should implement {@link #getEndpointName()} to specify the API endpoint path.</p>
 */
public abstract class Endpoint {
     ...
     * 
     * <p>This method should return the endpoint path (without leading slash) that will
     * be appended to the base URL to form the complete API endpoint.</p>
     * 
     ...
     * 
     * <p>This method makes an HTTP GET request to the API endpoint with the current
     * parameters and returns the response as a Jackson JsonNode object.</p>
     * 
     ...
     * 
     * <p>This method makes an HTTP GET request to the API endpoint with the current
     * parameters and returns the response as a CSV-formatted string.</p>
     * 
     ...
     * 
     * <p>This method constructs the complete URL that would be used for the API request,
     * including all parameters. This is useful for debugging and understanding what
