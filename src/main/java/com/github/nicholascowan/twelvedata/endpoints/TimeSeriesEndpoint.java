...
public class TimeSeriesEndpoint extends Endpoint {
  ...
  /**
   * Constructs a new TimeSeriesEndpoint with the given context.
   *
  ...
  /**
   * Constructs a new TimeSeriesEndpoint with the given context, symbol, and interval.
   *
   * @param context the TwelveData context containing configuration and HTTP client
  ...
  /**
   * Constructs a new TimeSeriesEndpoint with the given context and parameters.
   *
   * @param context the TwelveData context containing configuration and HTTP client
   * @param symbol the stock symbol
   * @param interval the time interval for the data
   ...
   * @param adjust the adjustment type
   */
  ...
  public TimeSeriesEndpoint prepost(Boolean prepost) {
    addParam("prepost", prepost);
    return this;
  }
  ...
  public TimeSeriesEndpoint figi(String figi) {
    addParam("figi", figi);
    return this;
  }

  public TimeSeriesEndpoint isin(String isin) {
    addParam("isin", isin);
    return this;
  }

  public TimeSeriesEndpoint cusip(String cusip) {
    addParam("cusip", cusip);
    return this;
  }

  public TimeSeriesEndpoint format(String format) {
    addParam("format", format);
    return this;
  }

  public TimeSeriesEndpoint delimiter(String delimiter) {
   ...
   */
  public TimeSeriesResponse asObject()
