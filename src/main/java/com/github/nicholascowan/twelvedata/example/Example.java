 ...
 *
 * <p>This class demonstrates how to use the TwelveData API client to fetch stock data, quotes, and
 * time series information.
 */
public class Example {

  /**
   * Main method demonstrating TwelveData API usage.
   *
   * @param args command line arguments (first argument is the API key)
   */
