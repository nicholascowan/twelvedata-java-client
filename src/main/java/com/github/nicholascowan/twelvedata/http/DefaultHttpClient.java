 ...
 * 
 * <p>This implementation provides HTTP client functionality for the TwelveData API using
 * the OkHttp library. It handles JSON and CSV responses, error mapping, and request
 * configuration.</p>
 * 
 * <p>Features:</p>
 * <ul>
 *   <li>Configurable timeouts for connect, read, and write operations</li>
 *   <li>Automatic source parameter addition for monitoring</li>
 *   <li>JSON response parsing and error handling</li>
 *   <li>CSV response support</li>
 *   <li>HTTP status code to exception mapping</li>
 * </ul>
 * 
 * <p>Default timeout is 30 seconds for all operations.</p>
 */
        ...
        try {
            ...
            if (jsonNode.has("status")) {
                ...
                if ("error".equals(status)) {
                    ...
                    String message = jsonNode.has("message") ? jsonNode.get("message").asText() : responseBody;
