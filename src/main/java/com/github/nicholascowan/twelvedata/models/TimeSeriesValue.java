...
public class TimeSeriesValue {
  ...
  /** Default constructor for TimeSeriesValue. */
  public TimeSeriesValue() {}

  /**
   * Constructs a new TimeSeriesValue with all fields.
   *
   ...
   */
  public TimeSeriesValue(
      String datetime, String open, String high, String low, String close, String volume) {
