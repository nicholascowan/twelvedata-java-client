...
public class ErrorResponse {
  ...
  /**
   * Constructs a new ErrorResponse with all fields.
   *
  ...
  public String getErrorDescription() {
    ...
    switch (code) {
      case 400:
        return "Bad Request: Invalid or incorrect parameter(s) provided. Check the message for"
            + " details and refer to the API Documentation.";
      case 401:
        return "Unauthorized: Invalid or incorrect API key. Verify your API key is correct.";
      case 403:
        return "Forbidden: API key lacks permissions for the requested resource. An upgrade may be"
            + " required.";
      case 404:
        return "Not Found: Requested data could not be found. Adjust parameters to be less strict.";
      case 414:
        return "Parameter Too Long: Input parameter array exceeds the allowed length. Follow the"
            + " message guidance.";
      case 429:
        return "Too Many Requests: API request limit reached for your key. Wait briefly or upgrade"
            + " your plan.";
      case 500:
