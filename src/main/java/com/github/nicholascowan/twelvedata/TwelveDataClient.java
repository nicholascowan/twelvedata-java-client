...
/**
 * Main client class for the TwelveData API.
 * Provides access to all API endpoints and functionality for retrieving financial market data.
 * 
 * <p>This client supports the following endpoints:</p>
 * <ul>
 *   <li><strong>Time Series</strong> - Historical OHLC (Open, High, Low, Close) data</li>
 *   <li><strong>Quote</strong> - Real-time quote information</li>
 *   <li><strong>Price</strong> - Current price data</li>
 * </ul>
 * 
 * <p>Example usage:</p>
 * <pre>{@code
...
public class TwelveDataClient {
    ...
    public TwelveDataClient(TwelveDataConfig config) {
        this.context = new TwelveDataContext(
    ...
    public TimeSeriesEndpoint timeSeries(String symbol, String interval, 
        ...
        return new TimeSeriesEndpoint(context, symbol, interval, exchange, country, type, outputsize,
                                    startDate, endDate, dp, timezone, order, prepost, date, micCode,
                                    previousClose, adjust);
    }
